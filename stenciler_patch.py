#!/usr/bin/env python3
"""
Patch pour ajouter le Stenciler à server_9998_v2.py
À exécuter après la ligne 1363 (fin du HTML de generate_html)
"""
...
print("Patch défini.")
print(f"CSS: {len(STENCILER_CSS)} caractères")
print(f"HTML: {len(STENCILER_HTML)} caractères")
print(f"JS: {len(STENCILER_JS)} caractères")
