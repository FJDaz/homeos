    ...
    updatePanel(shell) {
        ...
        auditContent.innerHTML = `
            <div class="flex items-center gap-2 mb-4">
                <span class="text-[10px] font-bold text-homeos-green uppercase underline decoration-2 underline-offset-4">screen active</span>
            ...
            <div class="space-y-3">
                ...
                <div class="p-3 bg-white border border-slate-100 rounded-lg shadow-sm">
                    <div class="text-[9px] font-bold text-slate-400 uppercase mb-1">Accessibility score</div>
                    <div class="flex items-center gap-2">
                        <div class="h-1 flex-1 bg-slate-100 rounded-full overflow-hidden">
                            <div class="h-full bg-homeos-green" style="width: 85%"></div>
                        </div>
                        <span class="text-[10px] font-bold text-slate-600">85%</span>
                    </div>
                </div>
            </div>
        `;
