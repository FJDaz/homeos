...
class WsScreenShell {
    ...
    static _addToolButtons(g, item, SW) {
        ...
        wireDiv.setAttribute('data-ux', 'NAV');
        wireDiv.setAttribute('data-ux-label', 'screen:wire');
        ...
        previewDiv.setAttribute('data-ux', 'NAV');
        previewDiv.setAttribute('data-ux-label', 'screen:preview');
        ...
        saveBtn.setAttribute('data-ux', 'ACTION');
        saveBtn.setAttribute('data-ux-label', 'screen:save');
