        ...
        drawer.innerHTML = `
            ...
            <div class="sd-section">
                ...
                <div id="sd-keys-list" class="space-y-6">
                    ${[
                        {id:'gemini',   price:'Gratuit (15 RPM)'},
                        {id:'groq',     price:'Gratuit (quota limité)'},
                        {id:'openai',   price:'~$0.005/1K tokens'},
                        {id:'kimi',     price:'~$0.01/1K tokens'},
                        {id:'mimo',     price:'Gratuit (via OpenRouter)'},
                        {id:'deepseek', price:'~$0.001/1K tokens'},
                        {id:'qwen',     price:'Gratuit (quota généreux)'},
                        {id:'watson',   price:'Gratuit (Lite tier)'},
                    ].map(p => `
